...
<div id="tab2" class="tab-pane hide"> 	
	...
	<div class="mt-2">
		...
		<div class="mt-1 d-flex">
			...
			<input  class="" type="hidden"  name="eqcn_icocta2" id="eqcn_icocta2" value="<?php echo esc_attr(get_option('eqcn_icocta2'))  ?> ">


			<input  class="ms-2 w-100" type="text"  name="eqcn_linkcta2" id="eqcn_linkcta2" value="<?php echo esc_attr(get_option('eqcn_linkcta2'))  ?>" placeholder="https://link.com">

		</div>
		
		<div id="eqcn_wa2" class="my-2  ">
			<label class="fw-bold d-none"><?php esc_html_e('Texto del CTA','eqconnect'); ?></label>
			<input  class=" w-100 mt-1 " type="hidden"  name="eqcn_watext2" id="eqcn_watext2" value="<?php echo esc_attr(get_option('eqcn_watext2'))  ?>" placeholder="<?php esc_html_e('Hola quiero saber...','eqconnect'); ?>">
		</div>
	</div>
